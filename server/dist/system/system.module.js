...
exports.SystemModule = SystemModule = __decorate([
    (0, common_1.Module)({
        imports: [tenants_module_1.TenantsModule, auth_module_1.AuthModule],
        controllers: [system_controller_1.SystemController, super_admin_controller_1.SuperAdminController],
    })
], SystemModule);
