...
export declare class NetworkElementsController {
    ...
    restoreRbs(id: string, req: any): Promise<import("typeorm").UpdateResult>;
    ...
    licensePoles(id: string): Promise<{
        success: boolean;
        message: string;
    } | {
        success: boolean;
    ...
    convertPointsToPoles(id: string): Promise<string[] | undefined>;
    convertPolesToPoints(id: string): Promise<{
        success: boolean;
    }>;
    calculateElevationDistance(id: string): Promise<{
        success: boolean;
        newLength: number;
    }>;
    ...
    updateCtoCustomer(id: string, data: Partial<CtoCustomer>): Promise<CtoCustomer>;
    ...
    deleteRbs(id: string, req: any): Promise<import("typeorm").UpdateResult>;
    ...
    deleteOnu(id: string, req: any): Promise<import("typeorm").UpdateResult>;
    ...
    getProjectDifferential(projectId: string, req: any): Promise<{
        projectId: string;
        projectName: string;
        stats: {
            poles: {
    ...
    getNetworkHeatmap(projectId: string): Promise<{
        latitude: number;
        longitude: number;
        uncoveredCount: number;
        reason: string;
